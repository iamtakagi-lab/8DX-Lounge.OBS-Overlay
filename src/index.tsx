...
const Overlay: React.FC<{ details: PlayerDetails }> = ({ details }) => (
    <div className="overlay">
        ...
        <div className="items">
            ...
            <p>MMR: {details.mmr} ({details.rank})</p>
    ...
    ctx.body = renderToStaticMarkup(<html lang="ja">
        ...
        <body>
            <main>
                ...
                <p>OBS等の配信ツールで <a href="https://www.mk8dx-lounge.com/">MK8DX 150cc Lounge</a> の Stats を表示するオーバーレイです。</p>
                <section>
                    <p>GitHub Repository: <a href="https://github.com/iamtakagi/8DX-Lounge.OBS-Overlay">https://github.com/iamtakagi/8DX-Lounge.OBS-Overlay</a></p>
                </section>
                <section>
                    <h2>使い方</h2>
                    <p>OBSでブラウザソースに <a href="https://8dxlounge-obs-overlay.vercel.app/overlay/(ラウンジのプレイヤー名)/(シーズン)">https://8dxlounge-obs-overlay.vercel.app/overlay/(ラウンジのプレイヤー名)/(シーズン)</a> を貼り付け、幅300 高さ800 を指定します。</p>
                    <p>例: <a href="https://8dxlounge-obs-overlay.vercel.app/overlay/takagi/5">https://8dxlounge-obs-overlay.vercel.app/overlay/takagi/5</a></p>
...
router.get("/overlay/:name/:season", async (ctx, next) => {
    ...
    ctx.body = renderToStaticMarkup(<html lang="ja">
        <head>
            ...
            <meta property="og:description" content={`${name} | lounge-obs-overlay`} />
            {/* 10分毎に自動リロード */}
